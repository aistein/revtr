...
try:
    ...
    print("usage: ./first_inside.py <dnet_type> <path_to_annotated_vp_dir> <ipasnfile> <opt: target dnet>")
    exit(1)
...
# return ip-address of first hop inside the target dnet from this probe
